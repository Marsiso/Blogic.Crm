...
/// <summary>
///     Validations for the <see cref="CreateClientCommand" /> command.
/// </summary>
public sealed class CreateClientCommandValidator : AbstractValidator<CreateClientCommand>
{
    public CreateClientCommandValidator(DataContext dataContext, IEmailLookupNormalizer emailNormalizer,
